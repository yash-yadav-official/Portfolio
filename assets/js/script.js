...
const selectValue = document.querySelector("[data-selecct-value]"); // Note: keeping original typo in selector
...
// FIXED: add event to all nav link
  ...
  navigationLinks[i].addEventListener("click", function () {
    ...
    for (let j = 0; j < pages.length; j++) {
      if (clickedNavText === pages[j].dataset.page) {
        ...
        this.classList.add("active"); // Add active to the clicked nav link
        window.scrollTo(0, 0);
        break;
      }
    }
